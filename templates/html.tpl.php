...
<head>
  ...
  <link href="http://fonts.googleapis.com/css?family=Roboto:400,400italic,700,700italic|Archivo+Narrow:700,700italic" rel="stylesheet" type="text/css">
  <?php print $styles; ?>
  <!--[if lt IE 9]>
    <link rel="stylesheet" href="<?php print $base_path . drupal_get_path('theme', 'aamga'); ?>/css/ie8-grid-foundation-4.css" type="text/css" />
    <script src="<?php print $base_path . drupal_get_path('theme', 'aamga'); ?>/js/respond.min.js"></script>
    <script src="<?php print $base_path . drupal_get_path('theme', 'aamga'); ?>/js/html5shiv.js"></script>
  <![endif]-->
  <?php print $scripts; ?>
</head>
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  <script>
    jQuery('.data-orbit').attr('data-orbit', '');
