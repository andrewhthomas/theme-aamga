...
<div class="container">
  <div class="row">
    <div class="large-3 columns" style="margin-top: 4px;">
      <label for="search" class="right inline">Search</label>
    </div>
    <div class="large-9 columns" style="margin-top: 4px;">
      <input type="text" id="search" name="search_block_form" placeholder="Type terms and press enter..." style="margin-bottom: 0; width: 98%;">
    </div>
  </div>
